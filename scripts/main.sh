...
请选择要操作的服务器节点：
 ...
 [1] 节点 A（总控机：当前服务器）  $(get_node_status node-a)
...
请选择要操作的区域：
 ...
 [1] 中国区 (cn-north)       $(get_node_status cn-north)
 [2] 亚太区 (ap-southeast)   $(get_node_status ap-southeast)
 [3] 北美区 (us-east)        $(get_node_status us-east)
 [4] 欧洲区 (eu-central)     $(get_node_status eu-central)
 [5] 新增区域（一键接入向导）
 [6] 退服区域（安全擦除）
...
============================================================
[!] 企业级部署涉及云厂商账户、合规审计与生产数据，
[!] 建议先阅读 docs/ARCHITECTURE.md 与 ONBOARDING_NEW_REGION.md
============================================================
...
【密钥与证书管理】
============================================================
 [1] 轮转所有密钥（数据库 / SMTP / API Key）
 [2] 自动签发 / 续期 SSL 证书
 [3] 导入 Age / SealedSecrets 私钥
 [4] 查看密钥过期时间表
 [9] 返回主菜单
============================================================
EOF
...
【应急响应工具箱】
============================================================
[!] 以下操作具有高风险，请在确认事故后再使用！
============================================================
 [1] 跨国断网应急切换（启用降级路由）
 [2] etcd 快照恢复（10 分钟集群重建）
 [3] 数据库主从故障切换
 [4] 一键封禁可疑 IP / 国家
 [5] 触发应急通知模板（钉钉/企微）
 [9] 返回主菜单
...
============================================================
 ...
 [4] 术语表 (GLOSSARY.md)
 [5] Master 重建 SOP (MASTER-RECOVERY.md)
 [9] 返回主菜单
============================================================
EOF
    echo -n "请选择: "
